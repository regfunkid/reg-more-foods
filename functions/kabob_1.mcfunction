...
give @s firework_star[minecraft:custom_model_data=135,minecraft:max_damage=3,minecraft:damage=2,minecraft:max_stack_size=1,food={nutrition:6,saturation:14.4,eat_seconds:2.4},minecraft:item_name='{"text":"Kabob"}']